...
KEY_ALPHA_RESULT_ALL = f"{KEY_PREFIX}:alpha_result_all"
KEY_ALPHA_RESULT_ALL_LIST = f"{KEY_ALPHA_RESULT_ALL}:list"
KEY_ALPHA_RESULT_ALL_SET = f"{KEY_ALPHA_RESULT_ALL}:set"
